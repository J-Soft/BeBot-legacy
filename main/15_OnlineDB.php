...
{ // Start Class
    ...
    */
    function __construct(&$bot)
    {
        ...
        $this->bot->core("settings")
            ->create(
            "Reinvite", "Enabled", TRUE, "Should reinviting of users in the chat group after a restart be on or off?"
        );
        $this->bot->core("settings")
            ->create(
    ...
    */
    ...
    { // Start function pgjoin()
        ...
        $this->bot->db->query(
            "UPDATE #___online SET reinvite = '1' WHERE nickname = '" . $name
    ...
    */
    ...
    { // Start function pgleave()
        ...
        $this->bot->db->query(
            "UPDATE #___online SET reinvite = '0' WHERE nickname = '" . $name
                . "' AND botname = '" . $this->bot->botname . "'"
        );
    ...
    */
    ...
    { // Start function connect()
        ...
        $inpg = $this->bot->db->select(
            "SELECT nickname FROM #___online WHERE botname = '"
        ...
        $this->bot->db->query(
            "UPDATE #___online SET reinvite = '0' WHERE botname = '"
    ...
    */
    ...
    { // Start function status_change()
        ...
        $sql
            .= "VALUES ('" . $name . "', '" . $this->bot->botname . "', '" . $newstatus . "', '" . time() . "', " . $level
            . ") ";
        $sql
            .= "ON DUPLICATE KEY UPDATE " . $column . " = '" . $newstatus . "', " . $column . "_changetime = '" . time()
            . "', level = " . $level;
    ...
    */
    ...
    function logoff($name)
    {
        ...
        $this->bot->db->query(
            "UPDATE #___online SET status_gc = '0' WHERE nickname = '" . $name . "' AND botname = '"
                . $this->bot->botname . "'"
        );
    ...
    {
        $str
            = " #___online AS t1 LEFT JOIN #___whois AS t2 ON t1.nickname = t2.nickname AND " . $this->otherbots("t1.");
    ...
    */
    ...
    function list_users($channel)
    {
        ...
        $query
            = "SELECT nickname FROM #___online WHERE ($where_clause) AND botname = '{$this->bot->botname}' ORDER BY nickname";
