...
class AccessControl_Core extends BasePassiveModule
{
  ...
  function __construct(&$bot)
  {
    ...
    $this->bot->core("settings")->create("AccessControl", "DefaultLevel", "SUPERADMIN", "Which is the minimal access level that should get access to new commands on default? Or should the default for new commands be to disabled access to them at all?", "ANONYMOUS;GUEST;MEMBER;LEADER;ADMIN;SUPERADMIN;OWNER;DISABLED");
