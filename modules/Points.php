...
class Points extends BaseActiveModule
{
    ...
    */
    ...
    function update_table()
    {
        ...
        switch ($this->bot->db->get_version("raid_points"))
        {
            ...
            case 2:
                $this->bot->db->update_table("raid_points", "nickname", "add",
            ...
            case 3:
                $this->bot->db->update_table("raid_points", "raidingas", "add",
    ...
    */
    function all_points($name)
    {
        ...
        $this->bot->send_tell($name, "All raidpoints :: " . $this->bot
    ...
    */
    function top_points($name)
    {
        ...
        if (!empty($result)) {
            ...
            $this->bot->send_tell($name, "Top 25 raidpoints :: " . $this->bot
                ->core("tools")->make_blob("click to view", $inside));
        }
        else
        {
    ...
    */
    function transfer_points($name, $toggle)
    {
        if ($this->bot->core("security")->check_access($name, "superadmin")) {
            ...
            $this->bot->send_tell($name, "Transfering points has been ##highlight##" .
                                         $txt . "##end##.");
        }
        else
        {
    ...
    */
    ...
    function view_log($name, $timeorname, $time2)
    {
        ...
        if ($ownlogs || $this->bot->core("security")
            ...
            if (!empty($logs)) {
                ...
                foreach ($logs as $log)
                {
                    ...
                    $inside .= "\n\n" . gmdate($this->bot->core("settings")
                        ->get("Time", "FormatString"), $log[3]) . " GMT";
