...
class OnlineDisplay extends BaseActiveModule
{
  ...
  */
  function __construct(&$bot)
  {
    ...
    $this->bot->core("settings")->create("Online", "SortBy", "nickname", "Should the characters of each " . $this->cp . " be sorted by nickname or level?", "nickname;level");
  ...
  */
  function online_msg($param, $what, $name = False)
  {
    ...
    $profstring = "";
    if ($param != "") {
      if (($profname = $this->bot->core("professions")->full_name($param)) instanceof BotError) {
        return $profname;
      }
