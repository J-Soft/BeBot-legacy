...
class Alts extends BaseActiveModule
{
    ...
    */
    function __construct(&$bot)
    {
        ...
        $this->help['command']['alts [player]']
            = "Shows information about [player]. If no player is given it shows information about yoru alts";
    ...
    */
    function add_alt($name, $alt, $admin = 0)
    {
        ...
        if (!empty($result)) {
            if ($result[0][1] == 1) {
                return ("##highlight##$alt##end## is already registered as an alt of ##highlight##" . $result[0][0]
                    . "##end##.");
            }
            else {
                return ("##highlight##$alt##end## is already an unconfirmed alt of ##highlight##" . $result[0][0]
                    . "##end##.");
            }
        }
        ...
        if ($name == $main) {
            ...
            if (!empty($result)) {
                if ($result[0][1] == 0) {
                    return ("##highlight##$name##end## is already an unconfirmed alt of ##highlight##" . $result[0][0]
                        . "##end##.");
                }
            }
        }
