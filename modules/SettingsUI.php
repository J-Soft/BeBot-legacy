...
{ // Start Class
    function __construct(&$bot)
    {
        ...
        $this->help['command']['set <module> <setting> <value>']
            = "Sets the setting <setting> for module <module> to <value>.";
    ...
    */
    ...
    { // Start function show_module()
        ...
        foreach ($result as $setting) { // 0 = setting, 1 = value, 2 = datatype, 3 = longdesc, 4 = defaultoptions
            ...
            {
                $inside
                    .= "##ao_infoheadline##" . $setting[0] . ":##end##  <font color=" . $setting[1] . ">" . $setting[1]
                    . "</font>\n";
            }
            else // Normal Setting Display.
            {
                $inside
                    .= "##ao_infoheadline##" . $setting[0] . ":##end## ##ao_infotextbold## " . $setting[1] . "##end##\n";
            }
    ...
    { // Start function change_setting()
        ...
        if ($result['error']) {
            ...
            return "Changed setting " . $setting . " for module " . $module . " to " . strval($value) . " ["
