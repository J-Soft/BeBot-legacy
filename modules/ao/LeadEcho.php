...
* Revision: $Id: LeadEcho.php 1833 2008-11-30 22:09:06Z alreadythere $
*/
...
class LeadEcho extends BaseActiveModule
{
    function __construct(&$bot)
    {
        ...
        $this->help['command']['leader [<name>]']
            = "Toggles leader status for yourself if no name is given, otherwise makes <name> new leader.";
    ...
    function set_leader($caller, $leadername, $repeatstring)
    {
        ...
        if ($this->bot->core("settings")->get("Leader", "Name") != ''
            && ($this->bot->core("security")->get_access_level($caller) <
                $this->bot->core("security")->get_access_level(
                    $this->bot
