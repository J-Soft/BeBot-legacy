...
class tokens extends BaseActiveModule
{
    ...
    */
            ...
            if ($count == 3) {
                ...
                if ($count == 4) {
                    ...
                    if ($count == 1) {
                        ...
                        $return["content"] = "##normal##::: ##highlight##Token overview##end## ::: " . $this->bot
    ...
    function ShowTokens($level, $goal, $current, $clan)
    {
        ...
        $inside .= "Veteran tokens(##highlight##*##end##): ##highlight##" . number_format($VetToke)
            . "##end## for ##highlight##" . number_format($Vet) . "##end## veteran points.\n";
        $inside
            .= "OFAB tokens(##highlight##**##end##): ##highlight##" . number_format($VPtoke) . "##end## for ##highlight##"
            . number_format($VP) . "##end## victory points.\n\n";

        $inside .= "##highlight##*##end## One veteran token is a set of 50 tokens, thus ##highlight##" . number_format(
            $VetToke
        ) . "##end## will equal ##highlight##" . number_format($Vet2) . " tokens.##end##\n";
        $inside
            .= "##highlight##**##end## OFAB tokens listed are the set of 10, thus ##highlight##" . number_format($VPtoke)
            . "##end## will equal ##highlight##" . number_format($VP2) . " tokens.##end####end##";
