...
class Target extends BaseActiveModule
{
    function __construct(&$bot)
    {
        ...
        $this->bot->core("settings")
            ->create(
            "Target", "Channel", $def, "Which channel should be used for output of the target spam?", "pgmsg;gc;both"
        );
    ...
    */
    function call_target($name, $msg)
    {
        ...
        $this->bot->send_output(
            $name, "ALL ASSIST <font color=#ffff00>$name</font>! " .
            "Target is <font color=#ff1111>&gt;&gt;<font color=#ffff00> $message</font>&lt;&lt;</font> :: " .
            $this->bot->core("tools")
                ->make_blob("click for more", $inside), $this->bot
