...
* Revision: $Id: Level.php 1833 2008-11-30 22:09:06Z alreadythere $
*/
...
class Level extends BaseActiveModule
{
    function __construct(&$bot)
    {
        ...
        $this->help['command']['level <level>']
            = "Shows team and pvp ranges for a given <level> and which QL missions that level can roll";
    ...
    function get_level($lvl)
    {
        ...
        $return
            = "L <font color=#FFFF00>" . $lvl . "</font>: team " . $lvllow . "-" . $lvlhigh . "  |  PvP " . $pvplow . "-"
            . $pvphigh . "  |  " . $this->xplevel[$lvl] . $xp . "  |  missions<font color=#66CCFF>" . $mishlist
            . "</font>";
        Return ($return);
    }
    ...
    function get_mish($mish)
    {
        ...
        $return = "QL <font color=#ffff00>" . $mish
            . "</font> missions maybe from these level players (+/- 1):<font color=#69c5ff> " . $this->mission[$mish]
            . "</font>";
        Return ($return);
    }
}
