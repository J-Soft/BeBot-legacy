...
class TowerAttack extends BaseActiveModule
{
	function __construct(&$bot)
	{
		...
		$this -> bot -> core("settings") -> create("TowerAttack", "SuppressTime", 30, "This is the time after last attack on same org that the attack with be suppressed for in seconds", "10;20;30;60;120;180;300");
	...
	function update_table()
	{
		...
		switch ($this -> bot -> db -> get_version("tower_result"))
		{
			case 1:
				...
				$this -> bot -> db -> update_table("tower_result", array("time", "win_guild", "win_side", "lose_guild", "lose_side", "zone"), "alter",
	...
	*/
	function gmsg($name, $group, $msg)
	{
		...
		if ($attack)
		{
			...
			{
				$spamtime = $this -> bot -> core("settings") -> get("TowerAttack", "SuppressTime");
	...
	function cron()
	{
		if (!empty($this -> suppress))
		{
			...
			{
				$spamtime = $this -> bot -> core("settings") -> get("TowerAttack", "SuppressTime") + 5;
