    ...
    function server_load()
    {
        ...
        foreach ($playfields as $key => $val) {
            if ($playfields[$key]['status'] == 1) {
                $inside
                    .= " " . $key . ": ##highlight##" . $playfields[$key]['load'] . " - " . $playfields[$key]['players']
                    . "%##end##\n";
            }
            else {
                if ($playfields[$key]['status'] == 2) {
                    $inside .= " ##yellow##" . $key . "##end##: ##highlight##" . $playfields[$key]['load'] . " - "
                        . $playfields[$key]['players'] . "%##end##\n";
                }
                else {
                    $inside .= " ##red##" . $key . "##end##: ##highlight##" . $playfields[$key]['load'] . " - "
                        . $playfields[$key]['players'] . "%##end##\n";
                }
            }
