...
class Gemcut extends BaseActiveModule
{
    ...
    function gemtiers($msg)
    {
        ...
        case 2:
            $txt
                = "Tier 2 gems are (level 50-59): Onyx, Lapis Lazuli, Malachite, Tiger Eye, Iolite, Jasper, Zircon and Chrysoberyl. Drops in: Eiglophian Mountains.";
            break;
        case 3:
            $txt
                = "Tier 3 gems are (level 60-69): Jet, Turquoise, Peridot, Chalcedony, Amethyst, Garnet, Moonstone and Sagenite. Drops in: Thunder River, Atzel's Approach";
            break;
        case 4:
            $txt
                = "Tier 4 gems are (level 70-74): Black Jasper, Aquamarine, Sphene, Sunstone, Duskstone, Blood Opal, Achronite and Topaz. Drops in: Atzel's Approach, Keshatta";
            break;
        case 5:
            $txt
                = "Tier 5 gems are (level 75-79): Nightstar, Sapphire, Jade, Fire Agate, Royal Azel, Ruby, White Opal and Heliodor. Drops in: Keshatta";
            break;
        case 6:
            $txt
    ...
    function gems($msg)
    {
        if (preg_match("/[1-6]/", $msg)) {
            $txt
                = "##gemcut_highlight##Tier $msg gems##end## : Level " . $this->tier_info[$msg - 1][0] . " - Drops in: "
                . $this->tier_info[$msg - 1][1] . ".\n\n<hr/>\n\n";
            ...
            for ($i = 0; $i < count($this->tier_info); $i++) {
                $txt .= $this->bot->core("tools")
                    ->chatcmd("gems " . ($i + 1), "Tier " . ($i + 1) . " gems") . " : Level " . $this->tier_info[$i][0]
                    . " - Drops in: " . $this->tier_info[$i][1] . ".\n";
            }
        ...
        foreach ($lines as $line) {
            ...
            if ($is_rare) {
                if ($rarity == 2 || $rarity == 1) {
                    ...
                    $text .= $this->renderLink($prefix, "Cabochon", $gem, "Arm", $cut_arm)
                ...
                if ($rarity == 2 || $rarity == 0) {
                    ...
                    $text
                        .= $this->renderLink($prefix, "Oblique", $gem, "Arm", $cut_arm) . " ##gemcut_highlight##:##end## ";
                    $text .= "##gemcut_info##(##end##$effect##gemcut_info##)##end##\n";
                }
            }
        }
