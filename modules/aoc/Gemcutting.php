...
class Gemcut extends BaseActiveModule
{
    ...
    function __construct(&$bot)
    {
        ...
        $this->gem_types["black"]  = array(array("Obsidian",
                                                 "Onyx",
                                                 "Jet",
                                                 "Black Jasper",
                                                 "Nightstar",
                                                 "Black Diamond"));
        $this->gem_types["blue"]   = array(array("Azurite",
                                                 "Lapis Lazuli",
                                                 "Turqoise",
                                                 "Aquamarine",
                                                 "Sapphire",
                                                 "Star Saphire"));
        $this->gem_types["green"]  = array(array("Chrysoprase",
                                                 "Malachite",
                                                 "Peridot",
                                                 "Sphene",
                                                 "Jade",
                                                 "Emerald"));
        $this->gem_types["orange"] = array(array("Carnelian",
                                                 "Tiger Eye",
                                                 "Chalcedony",
                                                 "Sunstone",
                                                 "Fire Agate",
                                                 "Padpaasahsa"));
        $this->gem_types["purple"] = array(array("Rose Quartz",
                                                 "Iolite",
                                                 "Amethyst",
                                                 "Duskstone",
                                                 "Royal Azel",
                                                 "Tyrian Sapphire"));
        $this->gem_types["red"]    = array(array("Spinel",
                                                 "Jasper",
                                                 "Garnet",
                                                 "Blood Opal",
                                                 "Ruby",
                                                 "Star Ruby"));
        $this->gem_types["white"]  = array(array("Quartz",
                                                 "Zircon",
                                                 "Moonstone",
                                                 "Achroite",
                                                 "White Opal",
                                                 "Diamond"));
        $this->gem_types["yellow"] = array(array("Citrine",
                                                 "Chrysoberyl",
                                                 "Sagenite",
                                                 "Topaz",
                                                 "Heliodor",
        ...
        // Tier info
        $this->tier_info[] = array("40-49",
                                   "Field of the Dead, Noble District");
        $this->tier_info[] = array("50-59",
                                   "Eiglophian Mountains");
        $this->tier_info[] = array("60-69",
                                   "Thunder River, Atzel's Approach");
        $this->tier_info[] = array("70-74",
                                   "Atzel's Approach, Keshatta");
        $this->tier_info[] = array("75-79",
                                   "Keshatta");
        $this->tier_info[] = array("80+",
        ...
        foreach ($this->gem_types as $colour => $gems) {
            for ($i = 0; $i < count($gems[0]); $i++) {
                ...
                $this->gem_array[$gems[0][$i]] = array($i + 1,
                                                       $colour);
            }
        }
    }
