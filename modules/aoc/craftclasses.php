...
class craftclasses extends BaseActiveModule
{
    ...
    function update_table()
    {
        ...
        {
            case 1:
                $this->bot->db->update_table("craftingclass", "class1", "modify",
                ...
                $this->bot->db->update_table("craftingclass", "class2", "modify",
    ...
    function notify($name, $startup = false)
    {
        if ($this->bot->core("settings")
                ->get("Craftclasses", "Remind") && !$startup
        ) {
