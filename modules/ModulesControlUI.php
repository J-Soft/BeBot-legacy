...
class ModuleControlGUI extends BaseActiveModule
{
    ...
    */
    function disable($name, $key, $section)
    {
        ...
        $msg
            = "Disabled " . $section . "/" . $key . ".  You will need to restart the bot for the changes to take effect.";
        return $msg;
    }
    ...
    */
    function enable($name, $key, $section)
    {
        ...
        $msg
            = "Enabled " . $section . "/" . $key . ".  You will need to restart the bot for the changes to take effect.";
        return $msg;
    }
}
