...
*  USA
*
* File last changed at $LastChangedDate: 2009-01-20 16:20:22 +0100 (Tue, 20 Jan 2009) $
* Revision: $Id: Shutdown.php 1957 2009-01-20 15:20:22Z temar $
*/
...
class Shutdown extends BaseActiveModule
{
    function __construct(&$bot)
    {
        ...
        $this->bot->core("settings")
            ->create(
            "Shutdown", "QuietShutdown", false, "Do shutdown/restart quietly without spamming the guild channel?"
        );
    }
