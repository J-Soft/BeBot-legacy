    ...
    */
    ...
    function add_alias($name, $alias)
    {
        ...
        if (empty($result)) {
            ...
            $this->bot->db->query(
                "INSERT INTO #___alias (alias, nickname, main) VALUES ('" . $alias . "', '" . $name . "', " . $main
                    . ")"
            );
            ...
            return
                "##highlight##" . $alias . "##end## is Already an Alias off ##highlight##" . $result[0][0] . "##end##.";
        }
    }
    ...
    function del_alias($name, $alias)
    {
        ...
        if (!empty($result)) {
            if ($result[0][0] == $name) {
                ...
                return "Alias ##highlight##" . $alias . "##end## Belongs to ##highlight##" . $result[0][0]
                    . "##end## and can not be Deleted by you.";
            }
        }
        else {
