...
* Revision: $Id: Professions.php 1833 2008-11-30 22:09:06Z alreadythere $
*/
...
class Profession_Core extends BasePassiveModule
{
	...
	function __construct(&$bot)
	{
		...
		else
		{
			...
			$this -> units = array(
				'artillery' => array('Adventurer', 'Agent', 'Fixer', 'Soldier', 'Trader'),
				'control' => array('Bureaucrat', 'Engineer', 'Meta-Physicist', 'Trader'),
				'extermination' => array('Bureaucrat', 'Meta-Physicist', 'Nano-Technician'),
				'infantry' => array('Adventurer', 'Enforcer', 'Keeper', 'Martial Artist'),
				'support' => array('Adventurer', 'Doctor', 'Fixer', 'Keeper', 'Martial Artist', 'Meta-Physicist', 'Trader'));
		}
	}
